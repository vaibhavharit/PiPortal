...
<body>
  <center><h1>Finance Database Records</h1></center> <br>
  ...
  //include('bid.php');
  $sqlget = "SELECT * FROM financee";
  $sqldata = mysqli_query($conn, $sqlget) or die ('Error getting database');

  echo "<table>";
  echo "<tr><th>Client Name</th><th>Client Number</th><th>Client Email</th><th>Status</th><th>Attatchment</th></tr>";
